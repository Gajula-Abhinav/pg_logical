...
//creating database and table on cluster1
...
insert into empinfo (name, price) values ('ice',10.10);
insert into empinfo (name, price) values ('sweet',501.10);
insert into empinfo (name, price) values ('cream',94.20);
insert into empinfo (name, price) values ('cake',15.92);
insert into empinfo (name, price) values ('chocolate',20.10);
INSERT 5 5
...
//creating database and table on cluster2
